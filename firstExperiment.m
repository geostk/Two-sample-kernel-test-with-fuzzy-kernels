function [STAT1,STAT2]=firstExperiment(alph,m,shuff,nTest,nroEpoch,X,test)
...
for epoch= 1:nroEpoch
    for i=1:nTest        
        ...
        k_rbf=RBF_kernel(cell2mat(X(ind1,6:10)),cell2mat(X(ind1,6:10)),1/lambda);
        ...
        k_rbf=RBF_kernel(cell2mat(X(ind2,6:10)),cell2mat(X(ind2,6:10)),1/lambda);
        ...
        k_rbf=RBF_kernel(cell2mat(X(ind1,6:10)),cell2mat(X(ind2,6:10)),1/lambda);
