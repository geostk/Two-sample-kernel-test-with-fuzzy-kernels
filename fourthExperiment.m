function [STAT1,STAT2]=fourthExperiment(alph,m,shuff,nTest,nroEpoch,X,test)
...
for epoch= 1:nroEpoch
    ...
    for i=1:nTest
        ...
        [lambda6, ~ ,~]=computeLambda(cell2mat(X(ind1,6)),cell2mat(X(ind2,6)));
        k_6=RBF_kernel(cell2mat(X(ind1,6)),cell2mat(X(ind1,6)),1/lambda6);
        
        [lambda7, ~ ,~]=computeLambda(cell2mat(X(ind1,7)),cell2mat(X(ind2,7)));
        k_7=RBF_kernel(cell2mat(X(ind1,7)),cell2mat(X(ind1,7)),1/lambda7);
        
        [lambda8, ~ ,~]=computeLambda(cell2mat(X(ind1,8)),cell2mat(X(ind2,8)));
        k_8=RBF_kernel(cell2mat(X(ind1,8)),cell2mat(X(ind1,8)),1/lambda8);
        
        [lambda9, ~ ,~]=computeLambda(cell2mat(X(ind1,9)),cell2mat(X(ind2,9)));
        k_9=RBF_kernel(cell2mat(X(ind1,9)),cell2mat(X(ind1,9)),1/lambda9);
        
        [lambda10, ~ ,~]=computeLambda(cell2mat(X(ind1,10)),cell2mat(X(ind2,10)));
        k_10=RBF_kernel(cell2mat(X(ind1,10)),cell2mat(X(ind1,10)),1/lambda10);
        ...
        k_6=RBF_kernel(cell2mat(X(ind2,6)),cell2mat(X(ind2,6)),1/lambda6);
        k_7=RBF_kernel(cell2mat(X(ind2,7)),cell2mat(X(ind2,7)),1/lambda7);
        k_8=RBF_kernel(cell2mat(X(ind2,8)),cell2mat(X(ind2,8)),1/lambda8);
        k_9=RBF_kernel(cell2mat(X(ind2,9)),cell2mat(X(ind2,9)),1/lambda9);
        k_10=RBF_kernel(cell2mat(X(ind2,10)),cell2mat(X(ind2,10)),1/lambda10);
        ...
        k_6=RBF_kernel(cell2mat(X(ind1,6)),cell2mat(X(ind2,6)),1/lambda6);
        k_7=RBF_kernel(cell2mat(X(ind1,7)),cell2mat(X(ind2,7)),1/lambda7);
        k_8=RBF_kernel(cell2mat(X(ind1,8)),cell2mat(X(ind2,8)),1/lambda8);
        k_9=RBF_kernel(cell2mat(X(ind1,9)),cell2mat(X(ind2,9)),1/lambda9);
        k_10=RBF_kernel(cell2mat(X(ind1,10)),cell2mat(X(ind2,10)),1/lambda10);
